...
import { type SecondaryButtonProps } from './SecondaryButton.types';

export function SecondaryButton({ type = 'button', className, disabled, children, ...props }: SecondaryButtonProps) {
  return (
    <button
      {...props}
      className={clsx(
